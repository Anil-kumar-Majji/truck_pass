...
export const Stepper: React.FC<StepperProps> = ({ consentStatus, selectCompanyStatus, uinVerificationStatus, registrationStatus, confirmationStatus }) => {
    ...
    const registrationProcessItems = [
        { id: 1, title: "Consent & Agreement", inProgress: consentAgreed, completed: !consentAgreed },
        { id: 2, title: "Select Company", inProgress: (!consentAgreed && !companySelected), completed: companySelected },
        { id: 3, title: "UIN Verification", inProgress: (companySelected && !uinVerified), completed: uinVerified },
        { id: 4, title: "Registration ", inProgress: (uinVerified && !registrationCompleted), completed: registrationCompleted },
        { id: 5, title: "Submit Application", inProgress: (registrationCompleted && !confirmed), completed: confirmed },
        { id: 6, title: "Confirmation", inProgress: false, completed: confirmed },
    ]
    return (
